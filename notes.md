...
class com.learncs.restfulwebservices.HelloWorldBean
```
...
public java.lang.String com.learncs.restfulwebservices.HelloWorldController.helloWorld()
- Mapped "{[/hello-world-bean],methods=[GET]}" onto 
public com.learncs.restfulwebservices.HelloWorldBean com.learncs.restfulwebservices.HelloWorldController.helloWorldBean()
- Mapped "{[/error]}" onto 
...
```java
	public static final Contact DEFAULT_CONTACT = new Contact(
			"abc xyz", "http://www.google.com", "abc.xyz@gmail.com");
